...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="grid min-h-screen lg:h-screen lg:max-h-screen lg:grid-cols-2 lg:overflow-hidden">
      <AuthVisualPanel />
      <div className="flex min-h-0 flex-col overflow-y-auto bg-ivory px-6 py-8 lg:py-8">
