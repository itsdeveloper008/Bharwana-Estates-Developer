...
export const teamMembers: TeamMember[] = [
  {
    ...
    expertise: [
      ...
      "Owner & developer partnerships",
      "Brand stewardship",
    ],
    responsibilities: [
      "Set company vision and quality standards for every listing",
      "Oversee major negotiations and high-value introductions",
      "Guide partnerships with verified developers",
      "Protect the Bharwana name across markets",
    ],
    highlights: [
      "Founding executive of Bharwana Estates Developer",
      "Built the dual-floor model: Direct Owner + Developer Verified",
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Strengthen partnerships with project developers",
    ],
    highlights: [
